...
<div class="space-y-6">
    <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between lg:gap-0">
        <div class="w-full lg:flex-1 lg:max-w-lg">
            <form method="GET" action="{{ route('customer.sending-domains.index') }}" class="flex flex-col gap-2 lg:flex-row lg:items-center">
        ...
        @customercan('domains.sending_domains.permissions.can_create_sending_domains')
            <x-button href="{{ route('customer.sending-domains.create') }}" variant="primary" class="w-full lg:w-auto">Add Domain</x-button>
        @endcustomercan
    </div>
