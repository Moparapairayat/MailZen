...
<div class="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_420px] items-start">
            ...
            <div class="flex items-center justify-between gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <div class="flex items-center gap-3">
                    ...
                    @customercan('campaigns.permissions.can_create_campaigns')
                        <x-button type="button" id="btn-save" variant="primary">Create Campaign</x-button>
                    @endcustomercan
                </div>
            </div>
        </form>
    ...
    <div class="min-w-0 lg:sticky lg:top-6">
        <div class="p-3 bg-yellow-50 border border-yellow-200 rounded-md dark:bg-yellow-900/20 dark:border-yellow-800" id="spam-help">
