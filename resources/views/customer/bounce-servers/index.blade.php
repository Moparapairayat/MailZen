...
<div class="space-y-6">
    <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between lg:gap-0">
        <div class="w-full lg:flex-1 lg:max-w-lg">
            <form method="GET" action="{{ route('customer.bounce-servers.index') }}" class="flex flex-col gap-2 lg:flex-row lg:items-center">
        ...
        @customercan('servers.permissions.can_add_bounce_servers')
            <x-button href="{{ route('customer.bounce-servers.create') }}" variant="primary" class="w-full lg:w-auto">Add Server</x-button>
        @endcustomercan
    </div>
