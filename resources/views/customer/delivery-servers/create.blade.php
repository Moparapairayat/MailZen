            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                @if(($flow ?? null) === 'api')
                    <div class="sm:col-span-2 rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-gray-50 dark:bg-gray-800">
                        ...
                        <div class="mt-2">
                            <a href="{{ route('customer.integrations.index', ['tab' => 'delivery-servers']) }}" class="text-sm font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
                                Go to Integrations
                            </a>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <select name="type" id="type" required class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:text-gray-100 sm:text-sm">
                        @if(($flow ?? null) === 'smtp')
                            ...
                            <option value="sendmail" {{ old('type') == 'sendmail' ? 'selected' : '' }}>Sendmail</option>
                            <option value="zeptomail" {{ old('type') == 'zeptomail' ? 'selected' : '' }}>ZeptoMail</option>
                        @elseif(($flow ?? null) === 'api')
                            <option value="amazon-ses" {{ old('type') == 'amazon-ses' ? 'selected' : '' }}>Amazon SES</option>
                            <option value="mailgun" {{ old('type') == 'mailgun' ? 'selected' : '' }}>Mailgun</option>
                            <option value="sendgrid" {{ old('type') == 'sendgrid' ? 'selected' : '' }}>SendGrid</option>
                            <option value="postmark" {{ old('type') == 'postmark' ? 'selected' : '' }}>Postmark</option>
                            <option value="sparkpost" {{ old('type') == 'sparkpost' ? 'selected' : '' }}>SparkPost</option>
                            <option value="zeptomail-api" {{ old('type') == 'zeptomail-api' ? 'selected' : '' }}>ZeptoMail API</option>
                        @else
                            <option value="smtp" {{ old('type') == 'smtp' ? 'selected' : '' }}>SMTP</option>
                            <option value="sendmail" {{ old('type') == 'sendmail' ? 'selected' : '' }}>Sendmail</option>
                            <option value="zeptomail" {{ old('type') == 'zeptomail' ? 'selected' : '' }}>ZeptoMail</option>
                ...
                <div id="credential-fields" class="contents" @if(($flow ?? null) === 'api') style="display: none;" @endif>
                    <div>
                        ...
                        <input type="text" name="hostname" id="hostname" value="{{ old('hostname') }}" placeholder="smtp.example.com" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:text-gray-100 sm:text-sm">
                    </div>
                ...
                <div>
                    ...
                    <input type="number" name="timeout" id="timeout" value="{{ old('timeout', 30) }}" min="1" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:text-gray-100 sm:text-sm">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="max_connection_messages" id="max_connection_messages" value="{{ old('max_connection_messages', 100) }}" min="1" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:text-gray-100 sm:text-sm">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="pause_after_send" id="pause_after_send" value="{{ old('pause_after_send', 0) }}" min="0" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:text-gray-100 sm:text-sm">
                </div>
                ...
                <div class="sm:col-span-2">
                    <div class="flex items-center space-x-6">
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" name="use_for_email_to_list" value="1" {{ old('use_for_email_to_list') ? 'checked' : '' }} class="rounded border-gray-300 text-primary-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700">
