...
<div class="h-screen overflow-hidden flex flex-col" x-data="templateImportModal(@js([
    ...
    <form id="unlayer-form" method="POST" action="{{ route('customer.templates.unlayer.store') }}" class="shrink-0 space-y-4 px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur">
        @csrf
